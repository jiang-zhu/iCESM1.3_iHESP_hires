#include "dtypes.h"
!===================================================
! DO NOT EDIT THIS FILE, it was generated using ./genf90/genf90.pl 
    ...
    do i=1,nvars
       ...
       if (.not. is_time_varying(v1, file_has_unlimited_dim, file(1)%unlimdimid)) then
          ...
          call compare_one_var(v1=v1, numcases=n, file=file, varnum=i, &
                               vnotfound=vnotfound, vfailed=vfailed, &
...
# 169 "compare_vars_mod.F90.in"
  subroutine compare_one_var(v1, numcases, file, varnum, &
                             vnotfound, vfailed, ndiffs, nfilldiffs, &
                             tindex)
    ...
    case(nf90_int)
       call compare_var_int(numcases,file,(/varnum,v1%matchid/), &
                            idiff, ifilldiff, ierr, inotfound, &
                            tindex)
    case(nf90_float)
...
# 214 "compare_vars_mod.F90.in"
  end subroutine compare_one_var


  ! TYPE real,int,double
# 218 "compare_vars_mod.F90.in"
  subroutine compare_var_real(n,file, vid, idiff, ifilldiff, ifail, inotfound, tindex)
    integer, intent(in) :: n
    type(file_t) :: file(2)
    ...
    real(r4) :: fv1, fv2, rms, min_val(2), max_val(2), avgval(2), m1, rdmax
    real(r4) :: rms_normalized          ! rms normalized by absolute values
    real(r4) :: rms_normalized_denom    ! denominator for computing rms_normalized
    real(r4) :: rdsum                   ! sum of relative differences
    real(r4) :: rdlogsum                ! sum of negative log10 of relative differences
    real(r4) :: rdbar                   ! average of relative differences
    real(r4) :: rdlogbar                ! rdlogsum normalized by number of non-zero differences
...
# 496 "compare_vars_mod.F90.in"
  end subroutine compare_var_real
  ! TYPE real,int,double
# 218 "compare_vars_mod.F90.in"
  subroutine compare_var_int(n,file, vid, idiff, ifilldiff, ifail, inotfound, tindex)
    integer, intent(in) :: n
    type(file_t) :: file(2)
    integer, intent(in) :: vid(2)
    integer, intent(out) :: idiff      ! 1 if diffs in field, 0 otherwise (0 if only diffs are in fill pattern)
    ...
    integer(i4) :: fv1, fv2, rms, min_val(2), max_val(2), avgval(2), m1, rdmax
    integer(i4) :: rms_normalized          ! rms normalized by absolute values
    integer(i4) :: rms_normalized_denom    ! denominator for computing rms_normalized
    integer(i4) :: rdsum                   ! sum of relative differences
    integer(i4) :: rdlogsum                ! sum of negative log10 of relative differences
    integer(i4) :: rdbar                   ! average of relative differences
    integer(i4) :: rdlogbar                ! rdlogsum normalized by number of non-zero differences
    integer :: t(2), n1, n2, min_loc(2), max_loc(2), spacelen
    integer :: start(NF90_MAX_DIMS,2), kount(NF90_MAX_DIMS,2), dsizes(NF90_MAX_DIMS,2)
    logical, pointer :: mask(:,:)
    integer :: diffcnt, rdmaxloc
...
# 496 "compare_vars_mod.F90.in"
  ...
  ! TYPE real,int,double
# 218 "compare_vars_mod.F90.in"
  subroutine compare_var_double(n,file, vid, idiff, ifilldiff, ifail, inotfound, tindex)
    integer, intent(in) :: n
    type(file_t) :: file(2)
    integer, intent(in) :: vid(2)
    integer, intent(out) :: idiff      ! 1 if diffs in field, 0 otherwise (0 if only diffs are in fill pattern)
    ...
    real(r8) :: fv1, fv2, rms, min_val(2), max_val(2), avgval(2), m1, rdmax
...
# 528 "compare_vars_mod.F90.in"
  subroutine compute_var_stats_real (buf, nvalid, mask, min_loc, max_loc, min_val, max_val, avgval)
    ...
    real(r4), intent(out) :: min_val, max_val, avgval
...
# 528 "compare_vars_mod.F90.in"
  subroutine compute_var_stats_int (buf, nvalid, mask, min_loc, max_loc, min_val, max_val, avgval)
    ...
    logical, intent(in) :: mask(:)
    integer, intent(out) :: nvalid, min_loc, max_loc
    integer(i4), intent(out) :: min_val, max_val, avgval
...
# 596 "compare_vars_mod.F90.in"
  end function translate_loc


# 599 "compare_vars_mod.F90.in"
