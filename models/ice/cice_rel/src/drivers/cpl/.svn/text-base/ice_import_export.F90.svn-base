module ice_import_export
  ...
  use ice_flux        , only: fiso_atm, fiso_ocn, fiso_rain, fiso_evap, fiso_Qa
  use ice_flux        , only: fiso_Qref, HDO_ocn, H2_18O_ocn, H2_16O_ocn
  ...
  use ice_state       , only: tr_aero, tr_iage, tr_FY, tr_pond, tr_lvl, tr_iso
    ...
    do iblk = 1, nblocks
       ...
       do j = jlo, jhi
          do i = ilo, ihi
             ...
             if ( tr_iso ) then
                fiso_Qa(i,j,1,iblk)  = x2i(index_x2i_Sa_shum_HDO,n)
                fiso_Qa(i,j,2,iblk)  = x2i(index_x2i_Sa_shum_16O,n)
                fiso_Qa(i,j,3,iblk)  = x2i(index_x2i_Sa_shum_18O,n)
