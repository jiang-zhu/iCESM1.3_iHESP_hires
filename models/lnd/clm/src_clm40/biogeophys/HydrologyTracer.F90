...
!
  ...
  logical, public :: tracer_forc = .false.   ! is this CLM standalone, but with isotopic forcing?
!
! Public interfaces
!
...
!
  ...
  integer, parameter, public :: ludbg = 899      ! landunit index
  integer, parameter, public :: cdbg = 6623      ! column index
  integer, parameter, public :: pdbg = 36833     ! pft index
  integer, parameter, public :: pdbgi= 36831     ! pft starting index
  integer, parameter, public :: pdbgf= 36847     ! pft ending index
...
!        call HydrologyTracerRegister(3,'H218O', 1._r8, wiso_get_rnat(isph218o),isph218o)
    ...
    if (any(shr_infnan_isnan(Rstnd)) ) then
...
!-----------------------------------------------------------------------
 ...
 1  format('  --> HydrologyTracerRegister: ',i3,1x,a8,i3, &
...
!
   ...
   real(r8), pointer :: RCanopyVapor (:,:) ! vapour in canopy air space
   real(r8), pointer :: RCanopyWaterHist (:,:) ! tracer ratio of canopy liquid water
!
! Local variables
!
...
!         endif
    ...
    ! Redo the volumetric soil water where not lake (else should be "nan")
...
!!begin removal of canopy rescaling
#if 0
    ! H2OCAN (pft)
...
!!end removal of canopy rescaling
#endif
