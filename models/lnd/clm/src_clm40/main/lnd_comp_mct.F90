...
contains
  ...
  subroutine lnd_init_mct( EClock, cdata_l, x2l_l, l2x_l, NLFilename )
    ...
    call lnd_export(bounds, clm_l2a, clm_s2x, l2x_l%rattr, atm_prognostic)
  ...
  subroutine lnd_run_mct(EClock, cdata_l, x2l_l, l2x_l)
    ...
    call lnd_import( bounds, x2l_l%rattr, clm_a2l, a2l_not_downscaled_gcell, clm_x2s, atm_prognostic)
