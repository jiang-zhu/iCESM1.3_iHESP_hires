...
! !USES:
  ...
  use perf_mod
  use HydrologyTracer     , only : cdbg,mdbg,pdbg,HydrologyTracerRescale,pwtrc
!
! !PUBLIC TYPES:
  implicit none
!
...
!DEBUG
if(ldbg) then
write(6,*) 'clmdrv04: ctype/ltype=',col%itype(cdbg),lun%itype(clandunit(cdbg)),clandunit(cdbg)
write(6,*) 'clmdrv04: h2osurf=',cws%h2osoi_liq(cdbg,cps%snl(cdbg)+1),cws%wtr_h2osoi_liq(cdbg,cps%snl(cdbg)+1,mdbg)
write(6,*) 'clmdrv04: qdrain=',cwf%qflx_drain(cdbg),cwf%wtr_qflx_drain(cdbg,mdbg)
write(6,*) 'clmdrv04: qinfl=',cwf%qflx_infl(cdbg),cwf%wtr_qflx_infl(cdbg,mdbg)
write(6,*) 'clmdrv04: qsurf=',cwf%qflx_surf(cdbg),cwf%wtr_qflx_surf(cdbg,mdbg)
write(6,*) 'clmdrv04: qrgwl=',cwf%qflx_qrgwl(cdbg),cwf%wtr_qflx_qrgwl(cdbg,mdbg)
write(6,*) 'clmdrv04: h2ocan \\ qsoil \\ qvege \\ qvegt =...'
do idbg=col%pfti(cdbg),col%pftf(cdbg)
...
!DEBUG
if(ldbg) then
write(6,*) 'clmdrv06: ctype/ltype=',col%itype(cdbg),lun%itype(clandunit(cdbg)),clandunit(cdbg)
write(6,*) 'clmdrv06: h2osurf=',cws%h2osoi_liq(cdbg,cps%snl(cdbg)+1),cws%wtr_h2osoi_liq(cdbg,cps%snl(cdbg)+1,mdbg)
write(6,*) 'clmdrv06: qdrain=',cwf%qflx_drain(cdbg),cwf%wtr_qflx_drain(cdbg,mdbg)
write(6,*) 'clmdrv06: qinfl=',cwf%qflx_infl(cdbg),cwf%wtr_qflx_infl(cdbg,mdbg)
write(6,*) 'clmdrv06: qsurf=',cwf%qflx_surf(cdbg),cwf%wtr_qflx_surf(cdbg,mdbg)
write(6,*) 'clmdrv06: qrgwl=',cwf%qflx_qrgwl(cdbg),cwf%wtr_qflx_qrgwl(cdbg,mdbg)
write(6,*) 'clmdrv06: h2ocan \\ qsoil \\ qvege \\ qvegt =...'
do idbg=col%pfti(cdbg),col%pftf(cdbg)
write(6,*) idbg,pws%h2ocan(idbg),pws%wtr_h2ocan(idbg,mdbg)
write(6,*) idbg,pwf%qflx_evap_soi(idbg),pwf%wtr_qflx_evap_soi(idbg,mdbg)
write(6,*) idbg,pwf%qflx_evap_veg(idbg),pwf%wtr_qflx_evap_veg(idbg,mdbg)
...
!DEBUG
if(ldbg) then
write(6,*) 'clmdrv07: ctype/ltype=',col%itype(cdbg),lun%itype(clandunit(cdbg)),clandunit(cdbg)
write(6,*) 'clmdrv07: h2osurf=',cws%h2osoi_liq(cdbg,cps%snl(cdbg)+1),cws%wtr_h2osoi_liq(cdbg,cps%snl(cdbg)+1,mdbg)
write(6,*) 'clmdrv07: qdrain=',cwf%qflx_drain(cdbg),cwf%wtr_qflx_drain(cdbg,mdbg)
write(6,*) 'clmdrv07: qinfl=',cwf%qflx_infl(cdbg),cwf%wtr_qflx_infl(cdbg,mdbg)
write(6,*) 'clmdrv07: qsurf=',cwf%qflx_surf(cdbg),cwf%wtr_qflx_surf(cdbg,mdbg)
write(6,*) 'clmdrv07: qrgwl=',cwf%qflx_qrgwl(cdbg),cwf%wtr_qflx_qrgwl(cdbg,mdbg)
write(6,*) 'clmdrv07: h2ocan \\ qsoil \\ qvege \\ qvegt =...'
do idbg=col%pfti(cdbg),col%pftf(cdbg)
write(6,*) idbg,pws%h2ocan(idbg),pws%wtr_h2ocan(idbg,mdbg)
write(6,*) idbg,pwf%qflx_evap_soi(idbg),pwf%wtr_qflx_evap_soi(idbg,mdbg)
write(6,*) idbg,pwf%qflx_evap_veg(idbg),pwf%wtr_qflx_evap_veg(idbg,mdbg)
