module clm_cpl_indices
 ...
 !**************
  ...
  integer, public ::index_l2x_Flrl_rofl_16O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofi_16O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofl_18O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofi_18O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofl_HDO     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofi_HDO     ! lnd->rtm input fluxes
 !**************
...
contains
  ...
  subroutine clm_cpl_indices_set(atm_prognostic )
    ...
    use HydrologyTracer, only: tracer_forc
    use clm_varctl     , only: use_voc
    use HydrologyTracer, only: hydro_tracer, tracer_forc
    !
    ! !ARGUMENTS:
    implicit none
   ...
   !**************
    ...
    if ( hydro_tracer ) then
       index_l2x_Flrl_rofl_16O   = mct_avect_indexra(l2x,'Flrl_rofl_16O')
       index_l2x_Flrl_rofi_16O   = mct_avect_indexra(l2x,'Flrl_rofi_16O')
       index_l2x_Flrl_rofl_18O   = mct_avect_indexra(l2x,'Flrl_rofl_18O')
       index_l2x_Flrl_rofi_18O   = mct_avect_indexra(l2x,'Flrl_rofi_18O')
       index_l2x_Flrl_rofl_HDO   = mct_avect_indexra(l2x,'Flrl_rofl_HDO')
       index_l2x_Flrl_rofi_HDO   = mct_avect_indexra(l2x,'Flrl_rofi_HDO')
    end if
   !**************
   ...
   !**************
    ...
    elseif( tracer_forc ) then ! using water tracer with DATM, but with isotopic forcing? - TW
