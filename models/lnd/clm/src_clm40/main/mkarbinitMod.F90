...
!
    ...
    real(r8), pointer :: RGNIP(:,:)                 ! tracer climatology ratio
!
!
...
!    if(endp>pdbg .and. begp<pdbg) ldbg=.true.
    ...
    do m=1, pwtrc
       wtr_h2osoi_vol(begc:endc,         1:nlevsoi,m) = spval
       wtr_h2osoi_liq(begc:endc,-nlevsno+1:nlevsoi,m) = spval
       wtr_h2osoi_ice(begc:endc,-nlevsno+1:nlevsoi,m) = spval
